...
//       <h1 className='text-blue-10 0'>it works</h1>
//     </div>
//   )
// }
...
const Home: NextPage = () => {
  return (
    ...
    <div className="bg-slate-400 py-20 px-20 grid gap-10 min-h-screen">
      <div className="bg-white p-10 rounded-2xl round shadow-xl   ">
      ...
      <div className="bg-white overflow-hidden rounded-2xl round shadow-xl  ">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between">
            ...
            <div className="flex items-center space-x-5">
              <button className="p-1.5  rounded-lg bg-blue-200 justify-center items-center aspect-square w-8 font-medium text-xl text-gray-500">-</button>
              <span>1</span>
              <button className="p-1.5 rounded-lg bg-blue-200 justify-center items-center aspect-square w-8 font-medium text-xl text-gray-500">+</button>
            </div>
          </div>
          <div className="flex justify-between items-center">
          <div className="font-medium text-2xl">$450</div>
          <button className="bg-blue-500 p-2 text-center rounded-lg text-white">Add to cart</button>
          </div>
        </div>
      </div>
    </div>
